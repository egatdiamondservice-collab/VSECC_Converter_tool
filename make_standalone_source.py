...
libcpp = (root / "lib" / "library.cpp").read_text(encoding="utf-8")
...
(root / "lib" / "library.cpp").write_text(libcpp, encoding="utf-8")
...
# One-file target for vSECC Alpine/musl; no Python required at runtime.
target_compile_options(converter_tool PRIVATE -Os)
target_link_options(converter_tool PRIVATE -static)
""", encoding="utf-8")

print("Standalone source patch applied")
